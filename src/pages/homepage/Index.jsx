      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6">
        ...
        >
          ...
          >
            ...
            <div 
              className="absolute w-48 sm:w-72 md:w-96 h-48 sm:h-72 md:h-96 bg-red-500/10 rounded-full blur-3xl top-1/2 right-0"
              style={{
            ...
            <div className="absolute inset-0">
              {[...Array(window.innerWidth > 768 ? 20 : 10)].map((_, i) => (
                <div
                  key={i}
                  className="absolute w-1 sm:w-2 h-1 sm:h-2 bg-white/10 rounded-full"
                  style={{
                    left: `${Math.random() * 100}%`,
                    top: `${Math.random() * 100}%`,
                    transform: `translateY(${offset * (0.1 + Math.random() * 0.2)}px)`,
                  }}
                ></div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12">
              ...
              >
                <h1 className="text-4xl sm:text-6xl md:text-7xl xl:text-8xl font-bold text-white tracking-tighter leading-none">
                  LaceHub
                  <span className="block text-3xl sm:text-4xl md:text-5xl xl:text-6xl mt-2 sm:mt-4 bg-gradient-to-r from-red-500 to-orange-500 text-transparent bg-clip-text">
                    Curate Your Kicks
                  </span>
                </h1>
                <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto lg:mx-0">
                  Your personal inventory for the world&apos;s most sought-after sneakers. 
                  Track, match, and trade with the community.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4 justify-center lg:justify-start">
                  <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-black font-bold text-base sm:text-lg hover:bg-gray-100 transition-all duration-300">
                    Start Collection
                  </button>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-2 border-white text-white font-bold text-base sm:text-lg hover:bg-white hover:text-black transition-all duration-300"
                  >
                    Learn More
                  </button>
                </div>
