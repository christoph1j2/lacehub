  ...
  const teamMembers = [
    ...
    },
    {
      ...
      social: {
        ...
        linkedin:
          "https://www.linkedin.com/in/ernst-christoph-leschka-52385421b/",
      },
    },
    {
      name: "Vojtěch Šebek",
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div className="w-32 h-32 mb-6 relative">
                      ...
                      <div className="relative w-full h-full overflow-hidden rounded-full">
                        ...
                        <div
                          ...
                          style={{
                            backgroundImage: `url('https://via.placeholder.com/150?text=${member.name.charAt(
                              0
                            )}')`,
                    ...
                    <h3 className="text-xl font-bold text-accent-100">
                      {member.name}
                    </h3>
              ...
              <div className="bg-primary-800/50 rounded-2xl p-8 sm:p-10 backdrop-blur-sm border border-primary-700">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-6">
                    <label
                      htmlFor="name"
                      className="block text-primary-300 mb-2"
                    >
                      Your Name
                    </label>
                    <input
